...
<br>
  <div style="background-color: #0099ff; width: 100%; height: 100%; margin-right: 0px;padding: 20px;color: white;" class="panel-body">
            ...
            <h2 class="text-center">Xác nhận nộp học phí</h2>
			</div>
			<div class="panel-body">
				<div class="row">
           <form method="get">
             <div class="form-group" style="width: 400px; float: right;">
                <input type="text" class="form-control" placeholder="Nhập tên của bạn..." name="search">
...
$sql         = 'select * from loginstudent3 where 1 '.' limit '.$firstIndex.', '.$limit;
$productList = executeResult($sql);

$sql         = 'select count(id) as total from loginstudent3 where 1 ';
  ...
  if (isset($_REQUEST['ok'])) 
        {
            ...
            {
                $sql = "select * from loginstudent3 where name like N'%$search%'";
    ...
    echo '<tr style="color: white;">
        <td>'.(++$firstIndex).'</td>
                ...
                <td>'.$item['created_at'].'</td>
                    ...
                    echo "Không tìm thấy bạn nộp học phí nào!";
                }
            }
        }
?>
