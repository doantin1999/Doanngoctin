...
<div class="form-group">
            <input type="text" name="name" required="true" class="form-control" value="<?= $show['name'] ?>" readonly>
          </div>
          <div class="form-group">
            <input type="email" name="email" required="true" class="form-control" value="<?= $show['email'] ?>" readonly>
          </div>
          <div class="form-group">
            <input type="tel" name="phone" required="true" class="form-control" value="<?= $show['phone'] ?>" readonly>
          </div>
          <div class="form-group">
            <textarea name="address" required="true" class="form-control" rows="3" cols="10" readonly><?= $show['address'] ?></textarea>
          </div>
        <?php
      }?>
