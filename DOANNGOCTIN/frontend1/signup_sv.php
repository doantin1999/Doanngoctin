...
?>
  ...
  <input type="date" class="form-control" id="date1" name="date1" required autofocus>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Trường học" name="school" required autofocus />
                </div>
                <div class="form-group">
                	  <label for="class">Lớp:</label>
                     <select name="class" required autofocus>
    <option value="10" name="class">10</option>
    <option value="11" name="class">11</option>
    <option value="12" name="class">12</option>
  </select>
                </div> 
                 <div class="form-group">
                    <input type="checkbox"  name="subjects"  value="Toán">Toán
                     <input type="checkbox"  name="subjects1"  style="margin-left: 50px;" value="Lý">Lý
                      <input type="checkbox" name="subjects2"  style="margin-left: 50px;" value="Hóa">Hóa
                </div>      
                 <div class="form-group">
