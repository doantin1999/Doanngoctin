...
echo "Đà Nẵng: ".date("Y-m-d H:i"). ""; ?></p>
  ...
  <img src="kinhsuong1.jpg" class="header-image" width="1110" height="200" alt="Công ty TNHH Kính Sương" style="object-fit: cover;" alt="First slide">
  </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                        <h3 class="mt-4 mb-3">Viết bài đánh giá</h3>
                        <button type="button" onclick="document.getElementById('id02').style.display='block'" name="add_review" id="add_review" class="btn btn-primary">Bài đánh giá</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
 <h5 class="modal-title">Gửi bài đánh giá</h5>
            </div>
 ...
 if($_SESSION['email'])
    {
        ...
        $show = mysqli_fetch_assoc($result);?>
                <div class="form-group">
                     <img src="<?= $show['image'] ?>" alt="Avatar" class="avatar1" name="user_avatar" id="img_image"/>
                    <input required="true" type="hidden" class="form-control" id="user_avatar" name="user_avatar" value="<?= $show['image'] ?>" onchange="updateThumbnail()" readonly>
                    <input fload="left" type="text" name="user_name" id="user_name" required="true" class="form-control" value="<?= $show['name'] ?>" readonly>
                </div>
            <div class="form-group">
            <input  value="<?= $show['email'] ?>"  type="text" class="form-control" id="email" name="email" readonly>
          </div>
                        <?php
      }?>
                <div class="form-group">
                    <textarea name="user_review" id="user_review" class="form-control" placeholder="Bình luận của bạn"></textarea>
                </div>
                 <div class="form-group">
            <input required="true" placeholder="Dán ảnh liên kết vào đây" type="text" class="form-control" id="image" name="image"  onchange="updateThumbnail()">
            <img src="<?=$image?>" style="max-width: 200px" id="img_image1">
          </div>
