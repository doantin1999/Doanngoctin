...
">
    ...
    width: 180px;
">Trang chủ</a></li>
  <li style="height:50px;text-align: center;color: white;"><a href="new.php" title="Giới thiệu" style="
    height: 50px;
    width: 220px;
">Giới thiệu</a></li>
...
<br>
  <div style="background-color: #0099ff; width: 100%; height: 100%; margin-right: 0px;padding: 30px;color: white;" class="panel-body">
			<tbody>
			<div class="panel-heading">
            <h2 class="text-center"><?=$product['name']?></h2>
			</div>
			<div class="panel-body">
         <p style="text-align: left;"><i class="far fa-clock"></i> <?=$product['updated_at']?></p>
				<div class="row">
            <p><img src="<?=$product['image']?>" style="max-width: 400px; float:left;object-fit: cover; margin-right: 20px;">
            <?=$product['title']?></p>
				</div>
			</div>
		</tbody>
