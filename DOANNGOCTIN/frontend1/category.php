...
<a href="information.php"> <?php
        ...
        echo'<img src="'.$show['image'].'" alt="Avatar" class="avatar" style="object-fit: cover;"/>';
        ?></a>
      <?php
    }
     ?>
        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="3">
                  <a href="index.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Tiếp tục đặt hàng</a>
                </td>
    ...
    <form action="search.php" method="get" style="margin-top:0px; width: 0px;">
	   ...
	   <div style="background-color: white; width: 100%; height: 100%; margin-right: 0px;padding: 0px;" class="panel-body">
			...
			<div class="panel-body">
				<div class="row">
<?php
$sql         = 'select * from product left join category on product.id_category = category.id where category.id='.$id;
$sql1         = 'select product.id, product.name,product.price, product.image, category.name category_name from product left join category on product.id_category = category.id where category.id='.$id;
