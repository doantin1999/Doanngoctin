...
if (isset($_GET['id'])) {
  ...
  $teacher = executeSingleResult($sql);
}
?>
<!DOCTYPE html>
<html>
...
<br>
  <div style="background-color: #0099ff; width: 100%; height: 100%; margin-right: 0px;padding: 20px;color: white;" class="panel-body">
      ...
      <div class="panel-heading">
            <h2 class="text-center">Thông tin tên <?=$teacher['name']?></h2>
      </div>
      <div class="panel-body">
        <div class="row">
            <p style="width: 600px;"><img src="<?=$teacher['image']?>" style="width: 140px; height: 200px; float:left;object-fit: cover; margin-right: 40px;margin-left: 200px;">
            Họ và Tên: <?=$teacher['name']?><br>
            Ngày sinh: <?=$teacher['date']?><br>
            Giới tính: <?=$teacher['gender']?><br>
            Đỉa chỉ: <?=$teacher['address']?><br>
            Số điện thoại: <?=$teacher['phone']?><br>
            Chức vụ: <?=$teacher['service']?><br>
            Tổ môn học: <?=$teacher['position']?><br>
            Lớp chủ nhiệm: <?=$teacher['class_id']?><br>
          </p>
        </div>
      </div>
    </tbody>
...
<p><i class='fas fa-map-marker-alt'></i>    37 Phạm Cự Lượng</p>
  ...
  <b>GIỜ MỞ CỬA</b>
  <p><i class="far fa-clock"></i>    Thứ 2-Thứ 7: 8-22H</p>
  </div>
</div>
  <script>
