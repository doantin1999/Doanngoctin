...
if (isset($_GET['id'])) {
	...
	$position = executeSingleResult($sql);
	if ($position != null) {
		$name = $position['name'];
	}
}
...
<div style="background-color:#d6d6c2;">  <p style="float:left; margin-right: 10px; margin-left: 10px;"><i class='fas fa-map-marker-alt'></i>    311 Đoàn Khuê</p>
...
">
    ...
    width: 180px;
">Trang chủ</a></li>
    <li style="height:50px;text-align: center;"><a href="new.php" title="Thời khóa biểu" style="
    height: 50px;
    width: 220px;
">Thời khóa biểu</a></li>
...
<div style="height: 50px;
    ...
    <form action="search.php" method="get" style="margin-top:10px; width: 250px;">
	   ...
	   <div style="background-color: white; width: 100%; height: 100%; margin-right: 0px;padding: 0px;" class="panel-body">
			...
			<div class="panel-body">
				<div class="row">
<?php
$sql         = 'select * from teacher left join position on teacher.position = position.id where position.id='.$id;
$sql1         = 'select teacher.id, teacher.name, teacher.position, teacher.image, teacher.service, position.name position_name from teacher left join position on teacher.position = position.id where position.id='.$id;
$productList = executeResult($sql);
    ?>
	      <div class="container">
    <div id="message"></div>
 <div class="row mt-1 pb-5" style="width: 1110px; min-height: 100%;">
      <?php
            include 'config.php';
        ...
        ?>
        <div class="card-deck">
          <div style="width: 300px; border:1px solid black; margin-left:65px; margin-bottom:20px;padding: 10px;">
