...
<html>
<head>
	<title>TRUNG TÂM TOÁN LÝ HÓA VÀ ÔN THI TRUNG HỌC PHỔ THÔNG QUỐC GIA</title>
...
echo "Đà Nẵng: ".date("Y-m-d H:i"). ""; ?></p>
	...
	<div class="container">
		<div class="panel panel-primary">
			...
			<div class="panel-body" style="background:#0099ff;color: white; padding: 15px;height: 100%;">
 ...
 if($_SESSION['email'])
    {
        ...
        $result = mysqli_query($conn, "select * from login where email = '$SESSION'"); // Use curly braces to access array members inside strings
        $show = mysqli_fetch_assoc($result); // now $show is an array that holds the user data
        echo'<img src="'.$show['image'].'" style="width: 150px;height: 200px;object-fit: cover;float:left;margin-right:20px;margin-left:250px;"/>';
            ...
            echo "Số điện thoại: {$show['phone']}</br></br>";
